...
public class HallButtonControl extends Controller{
    ...
    //Constructor for the HallButtonControl Class. Arguments in .cf file should match order and type given here.
    public HallButtonControl(int floor, Hallway hallway, Direction direction, boolean verbose){
        ...
        //Create a can mailbox for HallCall - this object has the binary representation of the message data
